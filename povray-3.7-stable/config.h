...
/* Host platform. */
#define BUILT_FOR "x86_64-unknown-linux-gnu (using -march=native)"
...
#define COMPILER_VER " (g++ 4.4.6 @ x86_64-unknown-linux-gnu)"

/* Compiler version. */
#define COMPILER_VERSION "g++ 4.4.6"

/* Compiler flags. */
#define CXXFLAGS "-pipe -Wno-multichar -Wno-write-strings -fno-enforce-eh-specs -s -O3 -ffast-math -march=native -pthread"

/* Who compiled this binary. */
#define DISTRIBUTION_MESSAGE_2 " Chris Neal chrisneal@ufl.edu"
